...
const Landing = () => {
  ...
  return (
    <section
      // ref={containerRef}
      className="min-h-screen flex flex-col md:p-48 p-6 text-primary-light bg-primary-dark"
    >
      {/* <Logo /> */}
      <div className="grid grid-cols-1  md:grid-cols-2 flex-1  w-full justify-between">
        <section className="flex flex-col gap-4 md:gap-0 justify-evenly">
          ...
          <Link
            to={"/plans"}
            className="bg-primary-light gap-4 flex items-center justify-center hover:opacity-80 duration-300 text-primary-dark md:w-2/4 w-full py-4 rounded-md"
          >
            Get started
